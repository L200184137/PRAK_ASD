...
c0 = MhsTIF("Ika", 103, "Sukoharjo")
c1 = MhsTIF("Budi", 511, "Sragen")
c2 = MhsTIF("Ahmad", 223, "Surakarta")
c3 = MhsTIF("Chandra", 218, "Surakarta")
c4 = MhsTIF("Eka", 423, "Boyolali")
c5 = MhsTIF("Fandi", 311, "Salatiga")
c6 = MhsTIF("Deni", 113, "Klaten")
c7 = MhsTIF("Galuh", 115, "Wonogiri")
c8 = MhsTIF("Janto", 123, "Klaten")
c9 = MhsTIF("Hasan", 164, "Karanganyar")
c10 = MhsTIF("Khalid", 129, "Purwodadi")
